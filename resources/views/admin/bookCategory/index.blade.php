                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('bookcategories.update', Crypt::encrypt($bookcat->id)) }}" enctype="multipart/form-data"
                                    method="post">
                                    {{ method_field('put') }}
                                    @csrf
                ...
                <div class="modal fade" id="delete{{ $bookcat->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('bookcategories.destroy', Crypt::encrypt($bookcat->id)) }}"
                                    method="post">
                                    {{ method_field('Delete') }}
                                    @csrf
