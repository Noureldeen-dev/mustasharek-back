...
@section('css')
@section('title')
    <?php echo $title = 'العلامات التجارية'; ?>
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" data-toggle="modal"
                                            data-target="#edit{{ $brand->id }}" title="تعديل"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('brands.update', Crypt::encrypt($brand->id)) }}"
                                    method="post">
                                    {{ method_field('put') }}
                                    @csrf
                ...
                <div class="modal fade" id="delete{{ $brand->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('brands.destroy', Crypt::encrypt($brand->id)) }}"
                                    method="post">
                                    {{ method_field('Delete') }}
                                    @csrf
                                    <h3 class="text-center">هل انت متأكد من عملية الحذف ؟</h3>
                                    <p class="text-center"> اذا تم الحذف سوف يتم حذف كل ماهو متعلق بهذه العلامة التجارية</p>
                                    <div class="modal-footer">
