                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" data-toggle="modal"
                                            data-target="#edit{{ $category->id }}" title="تعديل"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('categories.update', Crypt::encrypt($category->id)) }}"
                                    method="post">
                                    {{ method_field('put') }}
                                    @csrf
                                    ...
                                    <input class="form-control" type="text" value="{{ $category->name }}"
                                        ...
                                        <label for="Name" class="mr-sm-2">القسم
                                            :</label>
                                        <select name="section_id" class="form-control p-1"
                                            required>
                ...
                <div class="modal fade" id="delete{{ $category->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('categories.destroy', Crypt::encrypt($category->id)) }}"
                                    method="post">
                                    {{ method_field('Delete') }}
                                    @csrf
                                    <h3 class="text-center">هل انت متأكد من عملية الحذف ؟</h3>
                                    <p class="text-center"> اذا تم الحذف سوف يتم حذف كل ماهو متعلق بهذا الفئة</p>
                                    <div class="modal-footer">
