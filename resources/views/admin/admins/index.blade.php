                            ...
                            @foreach ($admins as $admin)
                                <tr>
                                    ...
                                    <td><img class="img-fluid sameImg avatar-small"
                                            src="{{ asset('assets/images/admins/' . $admin->avatar) }}" alt="">
                                    </td>
                                    <td>{{ $admin->name }}</td>
                                    <td><a class="text-primary"
                                            href="mailto:{{ $admin->email }}">{{ $admin->email }}</a> </td>
                                    <td>{{ $admin->created_at->format('Y-m-d') }}</td>

                                    <td>
                                        <button type="button" data-toggle="modal"
                                            data-target="#edit{{ $admin->id }}" title="تعديل"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('admins.update', Crypt::encrypt($admin->id)) }}"
                                ...
                                <div class="modal fade" id="delete{{ $admin->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="{{ route('admins.destroy', Crypt::encrypt($admin->id)) }}"
                                                    method="post">
                                                    {{ method_field('Delete') }}
                                                    @csrf
